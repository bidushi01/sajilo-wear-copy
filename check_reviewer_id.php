...
$user = getCurrentUser();
echo "<h2>🔍 Check Reviewer ID Issue</h2>";
    ...
    if (empty($reviews)) {
        ...
        foreach ($reviews as $review) {
            ...
            if ($review['reviewer_id'] == $user['id']) {
                ...
                echo "<p><strong>This is why clicking on your name shows your own profile instead of the reviewer's profile.</strong></p>";
            } else {
