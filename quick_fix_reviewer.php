...
$user = getCurrentUser();
echo "<h2>🔧 Quick Fix for Reviewer Links</h2>";
    ...
    if (empty($reviews)) {
        ...
        foreach ($reviews as $review) {
            ...
            if ($review['reviewer_id'] == $user['id']) {
                echo "<p style='color: red; font-weight: bold;'>❌ PROBLEM: Reviewer ID is same as your ID!</p>";
                echo "<p>This means the review was created incorrectly in the database.</p>";
            } else {
                echo "<p style='color: green;'>✅ Reviewer ID is different from your ID</p>";
            }
            
            // Show the actual link that would be generated
            $link = "view_user.php?id=" . $review['reviewer_id'];
            echo "<p><strong>Generated link:</strong> " . $link . "</p>";
            
            // Test the link
            echo "<p><strong>Test link:</strong> <a href='" . $link . "' target='_blank' style='background: #800000; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;'>Click to test</a></p>";
...
<html>
<head>
    <title>Quick Fix Reviewer</title>
    <style>
